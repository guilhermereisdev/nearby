package com.guilhermereisapps.nearby.data.model.mock
...
//        rules = mockRules,
    ...
    Market(
        id = "012576ea-4441-4b8a-89e5-d5f32104c7c5",
        categoryId = "146b1a88-b3d3-4232-8b8f-c1f006f1e86d",
        name = "Café Central",
        description = "Café aconchegante com opções de lanches e bebidas. Perfeito para uma pausa.",
        coupons = 1,
//        rules = emptyList(),
        latitude = -23.55974230991911,
        longitude = -46.65814845249887,
        address = "Alameda Haú - Jardim Paulista",
        phone = "(12) 3456-7890",
